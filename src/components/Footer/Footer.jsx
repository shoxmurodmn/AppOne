...
import EmailImg from '../../assets/icons/mail-fill.png';
        ...
        <footer className={cls.footer}>
            <Container>
                <div className={cls.footerContact}>
                    <div className={cls.footerContactItem}>
                        <div className={cls.footerContactItemBoxImg}>
                            <img src={EmailImg} alt="email" width='20' />
                        </div>
                        <a href="mailto:info@youremail.com">info@youremail.com</a>
                    </div>
                    <div style={{ paddingLeft: "20px", borderLeft: "2px solid #6C6C72"}}  className={cls.footerContactItem}>
                        <div className={cls.footerContactItemBoxImg}>
                            <img src={Phone} alt="email" width='20' />
                        </div>
                        <a href="mailto:info@youremail.com">info@youremail.com</a>
                    </div>
                </div>
                <div className={cls.footerWrapper}>
                    <div className={cls.footerLogo}>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur <br /> adipiscing elit.
                            Viverra nunc ante velit vitae. <br /> Est tellus vitae,
